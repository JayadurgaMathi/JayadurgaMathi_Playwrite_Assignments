...
const browser = await chromium.launch({headless:false,channel:"msedge"}); //here we are getting chromoium browser object from playwright llib
...
await page.goto("https://www.flipkart.com/") // goto - loading the URL) //title of your script, await should have async function
